...
2. The GitHub action, defined in the [`create-release.yaml`](ithub/workflows/create-release.yaml) file, creates a GitHub tag and draft release with the provided name.
